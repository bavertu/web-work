...
// Even though the strLit variable is a string literal for a primitive type, it can still use the toUpperCase() method because ethe string literal is converted to a string object behind the scenes. this is called boxing
...
// the instanceof operator returns true if an object is an instance of a constructor. it returns fa;se if it is a literal
...
const obj1 = {};
const obj2 = new Object(); // behinf the scenes, JS does this for the previous line as well
